    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='creator_eventset', to=settings.AUTH_USER_MODEL, verbose_name='Opprettet av')),

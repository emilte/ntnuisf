...
class Folder(models.Model):
    ...
    root_folder = models.ForeignKey('self', on_delete=models.SET_NULL, default=None, null=True, blank=True, related_name='children', verbose_name='Hovedmappe')
    private = models.BooleanField(default=True, blank=True, verbose_name='Privat mappe')

    last_editor = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, editable=False, related_name='editor_folderset', verbose_name='Sist redigert av'
    )
    last_edited = models.DateTimeField(null=True, blank=True, editable=False, verbose_name='Sist redigert')
    creator = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, editable=False, related_name='creator_folderset', verbose_name='Opprettet av'
    )
...
class Page(models.Model):
    ...
    folder = models.ForeignKey(Folder, on_delete=models.SET_NULL, null=True, blank=False, related_name='pages', verbose_name='Mappe')

    last_editor = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, editable=False, related_name='editor_pageset', verbose_name='Sist redigert av'
    )
    last_edited = models.DateTimeField(null=True, blank=True, editable=False, verbose_name='Sist redigert')

    creator = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, editable=False, related_name='creator_pageset', verbose_name='Opprettet av'
    )
    created = models.DateTimeField(null=True, blank=True, editable=False, verbose_name='Opprettet')
